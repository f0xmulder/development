...
class DesignRulesConfiguration(SingletonModel):
    base_url = models.CharField(
        max_length=255, default="https://staging.api-test.nl/",
        help_text="The base url of the called environment, make sure that it ands with a slash"
    )
    token = models.CharField(max_length=255, default='67d6c7b4ad656916bee7a2141a1414738515687f')
    default_version = models.IntegerField(
        help_text="This is the version that will be tested.", default=1
    )
