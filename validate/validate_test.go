...
func TestFile(t *testing.T) {
	testCases := []struct {
		...
		{"missing-environments.json", false, "", "the api is missing an environment with the name Productie"},
		{"missing-prod-env.json", false, "", "the api is missing an environment with the name Productie"},
		{"duplicate-env.json", false, "", "duplicate environment name found: Productie"},
