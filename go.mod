...
require (
	...
	github.com/couchbase/vellum v0.0.0-20190610202909-ec7b775d247f // indirect
	...
	golang.org/x/net v0.0.0-20190614054008-d28f0bde5980 // indirect
	golang.org/x/sys v0.0.0-20190617065354-15dcb6c0061f // indirect
)
