            ...
            <div className="APIDetails__technical">
                <dl>
                    ...
                    <dd data-test="api-documentation-url">
                        <a href={documentation_url} target="_blank">Read more</a>
                    </dd>
                    ...
                    <dd data-test="api-specification-type">
                        <a href={getOnlineRedocUrl(specification_url)} target="_blank" data-test="api-specification-url">{ api_specification_type }</a>
                    </dd>
                </dl>
            </div>
        </div>
